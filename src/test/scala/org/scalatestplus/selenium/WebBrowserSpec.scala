...
class WebBrowserSpec extends JettySpec with matchers.should.Matchers with SpanSugar with WebBrowser with HtmlUnit with InputFieldBehaviour {
  ...
  describe("textField") {
    it("should throw TFE with valid stack depth if specified item not found") {
      ...
      caught.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      caught.failedCodeFileName should be (Some("WebBrowserSpec.scala"))
    }
  ...
  describe("emailField") {
    it should behave like inputField[EmailField]("find-emailfield.html", emailField _, "EmailField", "email", "email1", "email2", here.lineNumber)
  }

  describe("colorField") {
    it should behave like inputField[ColorField]("find-colorfield.html", colorField _, "ColorField", "color", "#060606", "#070707", here.lineNumber)
  }

  describe("dateField") {
    it should behave like inputField[DateField]("find-datefield.html", dateField _, "DateField", "date", "2003-02-01", "2005-04-03", here.lineNumber)
  }

  describe("dateTimeField") {
    it should behave like inputField[DateTimeField]("find-datetimefield.html", dateTimeField _, "DateTimeField", "datetime", "2003-12-31T23:59:60Z", "2004-12-31T23:59:60Z", here.lineNumber)
  }

  describe("dateTimeLocalField") {
    it should behave like inputField[DateTimeLocalField]("find-datetimelocalfield.html", dateTimeLocalField _, "DateTimeLocalField", "datetime-local", "2003-12-31T23:59:60Z", "2004-12-31T23:59:60Z", here.lineNumber)
  }

  describe("monthField") {
    it should behave like inputField[MonthField]("find-monthfield.html", monthField _, "MonthField", "month", "2001-02", "2003-04", here.lineNumber)
  }

  describe("numberField") {
    it should behave like inputField[NumberField]("find-numberfield.html", numberField _, "NumberField", "number", "1.2", "3", here.lineNumber)
  }
  ...
  describe("searchField") {
    it should behave like inputField[SearchField]("find-searchfield.html", searchField _, "SearchField", "search", "search1", "search2", here.lineNumber)
  }

  describe("telField") {
    it should behave like inputField[TelField]("find-telfield.html", telField _, "TelField", "tel", "tel1", "tel2", here.lineNumber)
  }

  describe("timeField") {
    it should behave like inputField[TimeField]("find-timefield.html", timeField _, "TimeField", "time", "20:20:20", "21:21:21", here.lineNumber)
  }

  describe("urlField") {
    it should behave like inputField[UrlField]("find-urlfield.html", urlField _, "UrlField", "url", "http://1.bar.com", "http://2.bar.com", here.lineNumber)
  }

  describe("weekField") {
    it should behave like inputField[WeekField]("find-weekfield.html", weekField _, "WeekField", "week", "1996-W16", "1997-W17", here.lineNumber)
  }
  ...
  describe("switch to") {
    it("should switch frame correctly and throw TFE with valid stack depth if specified frame not found", Slow) {
      ...
      caught1.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      caught1.failedCodeFileName should be (Some("WebBrowserSpec.scala"))
      
      val caught2 = intercept[TestFailedException] {
        switch to frame(2)
      }
      caught2.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      caught2.failedCodeFileName should be (Some("WebBrowserSpec.scala"))
      
      val caught3 = intercept[TestFailedException] {
        switch to frame(id("text1"))
      }
      caught3.failedCodeLineNumber should be (Some(here.lineNumber - 2))
  ...
  describe("Web Browser") {
    ...
    it("should create, read and delete cookie correctly") {
      ...
      e1.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      ...
      e2.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      e2.failedCodeFileName should be (Some("WebBrowserSpec.scala"))
      
      val e3 = intercept[TestFailedException] {
        cookie("name3") should be (null)
      }
      e3.failedCodeLineNumber should be (Some(here.lineNumber - 2))
      e3.failedCodeFileName should be (Some("WebBrowserSpec.scala"))
      
      val e4 = intercept[TestFailedException] {
        delete cookie ("name1")
      }
      e4.failedCodeLineNumber should be (Some(here.lineNumber - 2))
